...
contract('FDS', function(accounts) {
  ...
  it('should store a file', async function() {
    let file = new File(['hello storage world'], `test${rand(0)}.txt`, {type: 'text/plain', size: 12345});
  ...
  it('should send a file', async function() {
    ...
    let file = new File(['hello sending world'], `test${rand(0)}.txt`, {type: 'text/plain', size: 12345});

    // let sent;
    // let outcome = await waitForAssert(async () => {
      sent = await acc1.send('test999', file, '/shared/fairdrop/encrypted', ()=>{}, ()=>{}, ()=>{});
    ...
    //   let messages = await acc2.messages('received', '/shared/fairdrop/encrypted');
  ...
  it('should send a 2nd file', async function() {
    ...
    let file = new File([msg], `test${rand(0)}.txt`, {type: 'text/plain', size: 12345});

    let sent = await acc1.send('test999', file, '/shared/fairdrop/encrypted', ()=>{}, ()=>{}, ()=>{});
  ...
  it('should send a 3rd file', async function() {
    ...
    var sent = await acc1.send('test999', file, '/shared/fairdrop/encrypted', ()=>{}, ()=>{}, ()=>{});
    var sent = await acc1.send('test999', file, '/shared/fairdrop/encrypted', ()=>{}, ()=>{}, ()=>{});
    var sent = await acc1.send('test999', file, '/shared/fairdrop/encrypted', ()=>{}, ()=>{}, ()=>{});
    var sent = await acc1.send('test999', file, '/shared/fairdrop/encrypted', ()=>{}, ()=>{}, ()=>{});
    var sent = await acc1.send('test999', file, '/shared/fairdrop/encrypted', ()=>{}, ()=>{}, ()=>{});
  ...
  it('should send a 4th file', async function() {
    ...
    let sent = await acc1.send(acc2.subdomain, file, '/shared/fairdrop/encrypted', ()=>{}, ()=>{}, ()=>{});
  ...
  it('should send a file from a third party', async function() {
    ...
    let sent = await acc3.send('test999', file, '/shared/fairdrop/encrypted', ()=>{}, ()=>{}, ()=>{});
