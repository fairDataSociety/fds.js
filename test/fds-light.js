...
contract('FDS', function (accounts) {
  ...
  before(async function () {
    if (process.env.TESTENV === 'noordung') {
      ...
      FDS = new fds(config)
    } else if (process.env.TESTENV === 'boma') {
      let config = {
        tokenName: 'gas',
  ...
  it('should create an account', async function () {
    await FDS.RestoreAccountFromPrivateKey(
      'subdomain',
      'password',
      '0xb9a8c4693db942c49a999c3a0eebfc8f9c9d2057628cfa1d62749df43c026143',
    )
  ...
  it('should restore an account twice', async function () {
    await FDS.RestoreAccountFromPrivateKey(
      'subdomain',
      'password',
      '0xb9a8c4693db942c49a999c3a0eebfc8f9c9d2057628cfa1d62749df43c026143',
