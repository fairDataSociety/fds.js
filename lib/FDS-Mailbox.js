...
class Mailbox {
    ...
    newInboxFeed(senderAccount, recipientSubdomain, multiboxAddress, feedLocationHash) {
        let multibox = new Multibox(senderAccount, this.config).at(multiboxAddress);
        return multibox.set('/shared/mail/feeds/'+senderAccount.address, feedLocationHash);
    }
