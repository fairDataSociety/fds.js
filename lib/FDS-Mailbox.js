...
class Mailbox {
    ...
    async getInboxFeed(senderAccount, subdomain, multiboxAddress, applicationDomain = 'shared'){
        let multibox = await new Multibox(senderAccount, this.config).at(multiboxAddress);
        return multibox.get('/shared/mail/'+applicationDomain+'/'+subdomain);
    }

    async getInboxFeeds(account, multiboxAddress, applicationDomain = 'shared'){
        let multibox = await new Multibox(account, this.config).at(multiboxAddress);
        return multibox.get('/shared/mail/'+applicationDomain);
    }
