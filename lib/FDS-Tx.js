...
class Tx {
    ...
    deployContract(account, abi, bytecode, args = [], nonce, gas = 8000000){
     ...
     */
    pay(account, toAddress, amount, gas = 8000000, transactionCallback = console.log, transactionSignedCallback = console.log) {
