...
class User {
  ...
  deployContract(abi, bytecode, args = [], nonce, gas = 8000000){
  ...
  */
  payAddress(recipientAddress, amount, gas = 8000000, transactionCallback = console.log, transactionSignedCallback = console.log) {
  ...
  * @returns {any} result
  */
  async pay(recipientSubdomain, amount, gas = 8000000, transactionCallback = console.log, transactionSignedCallback = console.log) {
