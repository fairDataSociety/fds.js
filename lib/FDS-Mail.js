...
class Mail {
    ...
    getMessages(type = 'received', account, path) {
        console.log("getMessages", type, account, path);
        switch (type) {
            case 'received':
    ...
    getReceivedMessages(recipientAccount, multiboxPath) {
        console.log("getReceivedMessages", recipientAccount, multiboxPath);
    ...
    getSentMessages(recipientAccount, multiboxPath) {
        console.log("getSentMessages", recipientAccount, multiboxPath);
